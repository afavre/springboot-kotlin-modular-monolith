...
class AccountControllerTest : FunSpec() {
    ...
    @MockkBean private lateinit var service: AccountService
    @MockkBean private lateinit var validator: AccountValidator
    ...
    init {
        ...
        test(
            ...
            every { service.createAccount(accountDto.toDomain()) } returns
                accountDto.copy(id = "1").toDomain()
